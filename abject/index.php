        ...
        <div class="flex space-x-3 items-center ">
          <div class="flex-none flex justify-center">
            <div class="w-12 h-12 flex ">
              <img
                src="https://cdn.onemars.net/sites/whiskas_th_r81SA_mwh5/image/thumb_cat-breeds-01_1652358723718.jpeg"
                alt="profile" class="shadow rounded-full object-cover" />
            </div>
          </div>
          <div class="hidden md:block  md:text-md text-black ">MONKOL</div>
        </div>
      </div>
    </div>
